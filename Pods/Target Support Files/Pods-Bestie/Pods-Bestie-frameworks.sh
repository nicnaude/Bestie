...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-Bestie/FBSDKCoreKit.framework"
  install_framework "Pods-Bestie/FBSDKLoginKit.framework"
  install_framework "Pods-Bestie/FBSDKShareKit.framework"
